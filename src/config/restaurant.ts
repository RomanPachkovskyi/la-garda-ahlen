...
export const restaurantConfig = {
  ...
  description: "Erleben Sie authentische italienische Küche mit frischen Zutaten und mediterraner Leidenschaft – direkt am Freibad Ahlen.",
  ...
  // Info Section Image
  infoImage: "https://images.unsplash.com/photo-1517248135467-4c7edcad34c4?w=1200&q=80",
  
  // Menu PDFs
  menuLunchPdfUrl: "/menu-mittag.pdf",
  menuDinnerPdfUrl: "/menu-abend.pdf",
  ...
  // Google Maps
  googleMapsUrl: "https://maps.google.com/?q=La+Garda+am+Freibad+Ahlen",
