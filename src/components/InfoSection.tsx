  ...
  return <>
        ...
        <div className="container relative z-10 mx-auto px-6 py-20 md:px-12 lg:px-16">
          <div className="max-w-xl">
            ...
            <div className="mt-10 flex flex-col gap-4 sm:flex-row">
              <Button asChild variant="outline" size="lg" className="group border-foreground/30 bg-transparent text-foreground hover:bg-foreground hover:text-primary-foreground">
      ...
      <section className="border-t border-border/30 bg-background py-6">
        <div className="container mx-auto px-6 md:px-12 lg:px-16">
          <div className="flex flex-col gap-6 md:flex-row md:flex md:items-center md:justify-center">
            ...
            <div className="flex flex-1 flex-col gap-3 md:basis-[65%] md:flex-col py-0 my-[20px] md:flex md:items-start md:justify-center md:gap-[13px]">
              ...
              <a href={`tel:${restaurantConfig.phone}`} className="flex items-center gap-3 text-sm text-foreground transition-colors hover:text-muted-foreground">
              ...
              <div className="flex items-center gap-3">
                ...
                <span className="text-sm text-muted-foreground">
                  {restaurantConfig.hours.map((slot, i) => <span key={i}>
                      {slot.days}: {slot.time}
            ...
            <div className="flex items-center justify-start gap-4 md:basis-[35%] md:justify-end">
              <a href={restaurantConfig.googleMapsUrl} target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-sm text-foreground transition-colors hover:text-muted-foreground">
